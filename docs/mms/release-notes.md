...
* 리포트 리스트에 작업명 추가
### 버그 수정
* PKI 오타 수정 : secureweb -> xecureweb


## 0.2.6 릴리즈
### 주요 내용
* SecureGuard 수정(Disk 추가 기능)
* 상단바로가기 버튼 추가(리포트 추가/수정)
* 여러 리포트 PDF 미리보기 추가
### 버그 수정
* DBSafer PDF 내용 안나오는 문제 수정
 
## 0.2.5 릴리즈
### 주요 내용
* JENNIFER 수정(서버 추가 가능하도록)
* Item 항목 삭제 버튼 적용

## 0.2.4 릴리즈
### 주요 내용
* 리포트 리스트 수정 : 조치 <-> 원인
* PDF 링크 공유 추가(카카오링크, 링크복사)
* PDF 저장 파일명 변경(회사-ITEM-년월일.pdf)
* 앱 아이콘 변경
...
* Custom Item 기능 추가
* 리포트 리스트에 조치/현상/원인 나오도록 수정
* 리포트 리스트에 엔지니어 3명 모두 나오도록 수정

## 0.2.2.1 릴리즈
### 주요 내용
* 구 Item 중에 varchar 범위를 넘는 data는 출력하는 대신 주석(# todo : ColumnSizeException) 처리
### 버그 수정
* PDF 표에서 일부 내용이 틀어지는 문제 수정
